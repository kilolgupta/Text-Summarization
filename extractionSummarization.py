...
# Remove the words like the, is, are etc as they give a false sense of information intersection
# Add URL extractors like Goose, boilerpipe
# Involve NLTK or OpenNLP packages for splitting or tokenizing text
# Intersection formula can be played with, use stopwords or stemming
# Instead of best sentence from each para, 2 3 best paragraphs could be picked
...
def main():
    ...
    text, patterns = gen()
    ans = solve_bf(text, 100, patterns)
    print(ans)
